...
public class ThistlethwaiteCubeTest {
	...
	// // given
	// ObservableCube observable =
	// CubeMapper.map(ThistlethwaiteCubeBuilder.solvedCube(),
	// Colour.getAllNonTransparentList());
	// ThistlethwaiteCube thistlethwaiteCube =
	// ThistlethwaiteCubeBuilder.solvedCube();
	// // when
	...
	// testMove(Move.E, ThistlethwaiteMove.EMPTY_0);
	// }
