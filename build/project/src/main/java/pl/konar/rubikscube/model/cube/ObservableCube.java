...
public class ObservableCube {
	...
	// { { 39, 51, 48, 36 }, { 10, 20, 26, 18 }, { 41, 53, 50, 38 }, { 11, 21,
	// 27, 19 }, { 37, 40, 52, 49 } }, // F
	// { { 33, 45, 42, 30 }, { 6, 16, 22, 14 }, { 34, 46, 43, 31 }, { 17, 23,
	// 15, 7 }, { 47, 44, 32, 35 } }, // B
	// { { 32, 43, 53, 40 }, { 13, 15, 29, 21 }, { 30, 44, 51, 41 }, { 14, 28,
	// 20, 12 }, { 42, 52, 39, 31 } }, // L
	// { { 38, 49, 47, 34 }, { 9, 19, 25, 17 }, { 36, 50, 45, 35 }, { 18, 24,
	// 16, 8 }, { 48, 46, 33, 37 } }, // R
	// { { 31, 41, 37, 35 }, { 12, 11, 8, 7 }, { 32, 39, 38, 33 }, { 13, 10, 9,
	// 6 }, { 40, 36, 34, 30 } }, // U
	// { { 52, 44, 46, 50 }, { 28, 23, 24, 27 }, { 53, 42, 47, 48 }, { 29, 22,
	// 25, 26 }, { 43, 45, 49, 51 } } // D
	// };
	...
	public void update(ObservableCube cube) {
		for (int index = 0; index < CubeConstants.NUMBER_OF_FACETS; ++index) {
			facets.set(index, cube.facets.get(index));
		}
	}
	...
	// setColour(permutation[n], getColour(permutation[(n + 1) %
	// permutation.length]));
	// }
